...
Python‑разработчик. Делаю чат‑боты и веб‑сервисы: Django/DRF, интеграции с внешними API и LLM, авторизация, тестирование, деплой (VPS/Docker).

## 🔧 Чем занимаюсь
- Проектирую и разрабатываю REST API (Django/DRF), модели данных, авторизацию
- Интегрирую внешние API и LLM, собираю чат‑боты под задачи
- Пишу автотесты (pytest/unittest), настраиваю линт и CI/CD
- Обеспечиваю деплой и эксплуатацию: VPS, Docker, Nginx, GitHub Actions
